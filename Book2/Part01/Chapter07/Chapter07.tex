...
\end{exercise}
\begin{solution}
自由蕴含投射，投射蕴含平坦由\cref{b2:thm:projective-flat}，平坦蕴含无挠由\cref{b2:prop:flat-torsionfree}。有限生成无挠模由\cref{b2:thm:pid-module-structure}自由，所以这组条件等价。去掉有限生成后，\(\mathbb Q\) 作为整数模无挠且平坦，却不投射，\subsecref{b2:subsec:0703:03}已用其到 \(\mathbb Z\) 的同态全为零证明这一点。所以至少“平坦推出投射”和“无挠推出自由”都失败。
\end{solution}
