...
非交换环中的分母不能任意换位。本章从共同倍数方程出发，完整构造正则分母的 Ore 局部化，再用一致维数、本质右理想与零化子链证明半素右 Goldie 环具有半单经典分式环。另一条线索讨论多项式恒等式：借助外代数与 Cayley–Hamilton 定理证明任意特征下的 Amitsur–Levitzki 恒等式。最后引入 Gelfand–Kirillov 维数，用增长计算比较有限维代数、多项式代数和自由代数，并辨明局部化的适用条件。
\end{chapterabstract}
