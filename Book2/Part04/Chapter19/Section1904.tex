...
设 \(k\) 为域，\(A\) 为非零有限生成含幺 \(k\) 代数。对整数 \(m\geq1\)，有 \(\operatorname{GKdim}_k M_m(A)=\operatorname{GKdim}_kA\)。任意含幺的有限生成 \(k\) 子代数 \(B\subseteq A\) 及任意非零商 \(k\) 代数 \(C=A/I\) 还满足
\[
