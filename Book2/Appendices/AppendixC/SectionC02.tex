...
\item 若 \(u:P\rightarrow Q\) 是有限生成投射 \(R\) 模之间的同态，则 \(u\) 为同构，当且仅当它在每个极大理想 \(\mathfrak m\) 处诱导的 \(u(\mathfrak m):P(\mathfrak m)\rightarrow Q(\mathfrak m)\) 为同构。
\end{enumerate}
\end{lemma}
\begin{proof}
...
设 \(R\) 为非零交换含幺环、\(A\) 为 Azumaya \(R\) 代数，则 \(A\) 的中心为 \(R1_A\)。
\end{proposition}
\begin{proof}
