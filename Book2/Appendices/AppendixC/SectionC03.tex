...
若 \(A,B\) 为 Azumaya \(R\) 代数，则 \(A^{\mathrm{op}}\) 与 \(A\otimes_RB\) 也为 Azumaya \(R\) 代数。
\end{proposition}
\begin{proof}
...
两个 Azumaya \(R\) 代数 \(A,B\) 称为 \(R\) 上 Brauer 等价，若存在忠实有限生成投射 \(R\) 模 \(P,Q\)，以及 \(R\) 代数同构
...
称与某个 \(\operatorname{End}_R(P)\) 同构的 Azumaya \(R\) 代数为在 \(R\) 上分裂，这里 \(P\) 忠实、有限生成且投射。它们都代表零类。反向也成立，证明见\cref{b2:prop:azumaya-zero-split}；证明将具体使用 Morita 等价，而不是把“同一 Brauer 类”误当成“同构”。

\begin{proposition}\label{b2:prop:ring-brauer-base-change}
交换环同态 \(f:R\rightarrow S\) 诱导群同态
\[
