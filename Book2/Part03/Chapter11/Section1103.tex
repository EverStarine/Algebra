...
代数 \(A\) 中满足 \(e^2=e\) 的元素称为\term[mideng-yuan]{幂等元}[idempotent]。两个幂等元 \(e,f\) 若满足 \(ef=fe=0\)，称它们正交。有限族 \(e_1,\ldots,e_r\) 两两正交且 \(\sum_i e_i=1\) 时，称 \(1=e_1+\cdots+e_r\) 为单位元的正交幂等元分解。
\end{definition}
