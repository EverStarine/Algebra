...
\ProseParagraphBreak
下面依次除以上一次非零余数的过程，称为\term[euclid-suanfa]{Euclid 算法}[Euclidean algorithm]，也称辗转相除法。
...
同时跟踪上述两列系数，称为\term[kuozhan-euclid-suanfa]{扩展 Euclid 算法}[extended Euclidean algorithm]。若已知一个求商余的具体程序，这就给出了以 \(a,b\) 为输入、以 \(d,u,v\) 为输出的有限计算。
