...
\ProseParagraphBreak
整除、主理想与唯一分解，可结合 Dummit 与 Foote 的《Abstract Algebra》\cite[Sections 8.1--8.3]{DummitFoote2003}学习。需要逐步计算最大公因子、模逆和分解时，可读 Shoup 的《A Computational Introduction to Number Theory and Algebra》\cite[Chapter 4, Section 16.9]{Shoup2008NumberTheoryAlgebra}；这些内容也便于比较整数运算与多项式运算中 Euclid 方法的共同之处。
