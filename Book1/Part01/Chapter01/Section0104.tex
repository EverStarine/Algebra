...
通过与任意相关对象之间满足指定相容条件的映射的存在性和唯一性，来刻画一个构造的条件，称为该构造的\term[fan-xingzhi]{泛性质}[universal property]。这些映射可以从所构造的对象出发，也可以映入该对象，方向须在具体陈述中固定。例如 \(X^*\) 连同字母映射 \(\iota:X\rightarrow X^*\) 的泛性质是：到任意幺半群的字母映射都能唯一延拓为同态。
\end{definition}
