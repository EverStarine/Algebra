...
\end{definition}
由定义，\(K\) 等于对应同态 \(\rho:G\rightarrow\operatorname{Sym}(X)\) 的核，也等于所有稳定子的交 \(\bigcap_{x\in X}G_x\)。\cref{b1:prop:kernel-fibers}说明同态单射当且仅当核平凡，因此忠实等价于 \(\rho\) 单射；自由则按定义等价于每个稳定子都平凡。
