...
\ProseParagraphBreak
建立对应定理只需第18章中的嵌入独立性，迹、范数和判别式的全部计算可以稍后再读。进入\secref{b1:sec:1903}的具体群计算时，再按所用方法补充工具：判别式判别使用\secref{b1:sec:1803}；模素数分解与循环型的联系使用中国剩余定理、有限域的 Frobenius 以及\cref{b1:lem:integral-closure-elementary}。后一个工具在\subsecref{b1:subsec:1903:04}完整证明，\secref{b1:sec:2103}将直接引用它处理具体五次方程。
