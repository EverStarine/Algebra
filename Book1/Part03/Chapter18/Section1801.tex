...
从任意群 \(G\) 到域 \(\Omega\) 的乘法群的互异乘法特征，在 \(\Omega\) 上线性无关。对无限族，这表示每个有限子族都线性无关。
\end{theorem}
\begin{proof}
...
若 \(\sigma_1,\ldots,\sigma_r:L\rightarrow\Omega\) 为不同的域嵌入，则它们作为 \(L\) 上的 \(\Omega\) 值函数线性无关。
\end{corollary}
\begin{proof}
...
设 \(f_1,\ldots,f_r:X\rightarrow\Omega\) 线性无关，则存在 \(x_1,\ldots,x_r\in X\)，使矩阵 \(\Bigl(f_i(x_j)\Bigr)_{i,j}\) 可逆。
\end{lemma}
\begin{proof}
