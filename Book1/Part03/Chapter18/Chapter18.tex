...
\ProseParagraphBreak
阅读任务可分开：建立有限 Galois 对应只需\secref{b1:sec:1801}的嵌入独立性；\secref{b1:sec:1802}至\secref{b1:sec:1803}的迹、范数和判别式用于扩张的线性代数计算；\secref{b1:sec:1804}中的整性工具则在后面的模素数约化计算中实际使用，不能把末节整体当作与计算无关的选读内容。
