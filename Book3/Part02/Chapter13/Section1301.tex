...
\(\bigcap_{n\ge0}I^nM=0\)，称此拓扑\term[fenli-tuopu]{分离}[separated]。序列 \(x_j\) 收敛于 \(x\)，是指对每个 \(n\)，充分大的 \(j\) 都有 \(x_j-x\in I^nM\)；若对每个 \(n\)，充分大的 \(i,j\) 都有 \(x_i-x_j\in I^nM\)，则称它为 Cauchy 序列。
\end{definition}
...
\]
特别地，\(N\) 闭当且仅当 \(M/N\) 的 \(I\) 进拓扑分离。每个模同态都是相应理想进拓扑下的连续映射。
\end{proposition}
\begin{proof}
