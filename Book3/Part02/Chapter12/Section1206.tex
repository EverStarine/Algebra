...
\xrightarrow{d}S\otimes_RS\otimes_RM,
\]
其中 \(d(s\otimes m)=1\otimes s\otimes m-s\otimes1\otimes m\)。
\end{lemma}
\begin{proof}
...
\ProseParagraphBreak
因此下降定理的输入始终是“模及其下降数据”，而不是仅有一个 \(S\) 模或各个纤维的维数。有限展示使所得对象仍有有限关系描述，余循环条件负责不同局部描述之间的相容性，两者承担不同的工作。
