...
设 \(K\) 为域，\(\Gamma\) 为全序交换群。若满射
\(v:K^*\rightarrow\Gamma\) 在扩充规定 \(v(0)=+\infty\) 后满足
\[
v(ab)=v(a)+v(b),\qquad
v(a+b)\ge\min\Bigl\{v(a),v(b)\Bigr\}.
\]
则称 \(v\) 为 \(K\) 上取值于 \(\Gamma\) 的\term[fuzhi]{赋值}[valuation]。第一式先对 \(a,b\in K^*\) 理解，第二式对所有 \(a,b\in K\) 成立；\(+\infty\) 大于每个群元素，且
...
设 \(K\) 为域，\(v:K^*\rightarrow\Gamma\) 为取值于全序交换群 \(\Gamma\) 的赋值。子环
\[
V_v=\{0\}\cup\Bigl\{a\in K^*\mid v(a)\ge0\Bigr\}.
\]
称为 \(v\) 的\term[fuzhihuan]{赋值环}[valuation ring]。
...
设 \(v:K^*\rightarrow\Gamma\) 为域 \(K\) 上的赋值。若赋值群 \(\Gamma\) 与通常排序的 \(\mathbb Z\) 同构，便称相应赋值环 \(V_v\) 为
