...
非零交换含幺环 \(R\) 若恰有一个极大理想 \(\mathfrak m\)，称为\term[jubu-huan]{局部环}[local ring]。写作 \((R,\mathfrak m)\)，或连同剩余域 \(\kappa=R/\mathfrak m\) 写作 \((R,\mathfrak m,\kappa)\)。
\end{definition}
...
局部环之间的含幺同态
\(\varphi:(R,\mathfrak m)\rightarrow(A,\mathfrak n)\) 若满足
\(\varphi(\mathfrak m)\subseteq\mathfrak n\)，称为\term[jubu-tongtai]{局部同态}[local homomorphism]。
\end{definition}
...
若 \(\varphi:R\rightarrow A\)、\(\mathfrak q\in\operatorname{Spec}A\)，并令
...
\[
v(ab)=v(a)+v(b),\qquad
v(a+b)\ge\min\Bigl\{v(a),v(b)\Bigr\}\quad(a+b\ne0).
\]
