...
设 \(k\) 是代数闭域。\(k[x_1,\ldots,x_n]\) 的每个极大理想唯一写成
\[
...
设 \(k\) 代数闭。理想 \(I\subseteq k[x_1,\ldots,x_n]\) 是真理想，当且仅当 \(Z_k(I)\ne\varnothing\)。因此有限组多项式 \(f_1,\ldots,f_r\) 没有公共零点，当且仅当存在多项式 \(g_1,\ldots,g_r\) 满足
\[
