...
预备知识为前两章的理想、素谱、局部化与局部环，以及第二卷第12.2节的有限长度与 Jordan–Hölder 定理。Hilbert 基定理的主要证明已在第一卷定理12.4.10给出，本章据此发展模论后果。阅读 Artin 环的证明时尤其要留意顺序：根的幂零性先于 Noether 性建立，不能在中途调用尚未得到的有限生成性。
