...
设 \(M\) 由 \(n\ge1\) 个元素生成，\(I\subseteq R\) 为理想，
...
交换环 \(R\) 的\term[Jacobson-gen]{Jacobson 根}[Jacobson radical]为
\[
...
设 \((R,\mathfrak m,\kappa)\) 为局部环，\(M\) 有限生成。
元素 \(m_1,\ldots,m_r\) 生成 \(M\)，当且仅当其剩余类生成
