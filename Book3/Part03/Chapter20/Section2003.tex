...
\]
每个 \(R_{\mathfrak p}\) 都是 DVR。若没有高度一素理想，则 \(R\) 为域，交集按 \(K\) 解释。
\end{theorem}
\begin{proof}
...
设 \(R\) 为交换 Noether 正规整环，\(K=\operatorname{Frac}(R)\)。以高度一素理想为基的自由交换群
\[
\operatorname{Div}(R)=\bigoplus_{\operatorname{ht}\mathfrak p=1}\mathbb Z[\mathfrak p]
\]
称为 \(R\) 的\term[Weilchuziqun]{Weil 除子群}[Weil divisor group]。其元素 \(D=\sum n_{\mathfrak p}[\mathfrak p]\) 为有限和，称为 Weil 除子；若各 \(n_{\mathfrak p}\ge0\)，称为有效除子。对 \(f\in K^*\)，定义主除子
\[
