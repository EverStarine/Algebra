...
**第一卷正文三编初稿已完成**：第一编第1—9章，36节、72题全解；第二编第10—13章，16节、59题全解；第三编“域扩张与 Galois 理论”第14—22章，37节、137题全解。合计22章、89节和268题，各编导读、章摘要与目标、正文证明及小结均已写入。可直接阅读 [Book1.pdf](Book1.pdf)。目前完成写作阶段的核对与编译，仍待正式审阅；第一卷附录A—E也已完成初稿，共18节、40小节、43题全解；后记、第二至五卷仍待撰写。正文与附录均待外部正式审稿。
...
|---|---|---:|---:|---:|---:|---:|---|
| 一 | [群、环、域与 Galois 理论](Book1/Book1.tex) | 3 | 22 | 89 | 5 | 18 | [Book1.pdf](Book1.pdf) |
...
当前五卷源码共设 1,634 个小节，五卷依次为 320、279、426、266、343 个。第一卷附录已按实际写作核定层级：原D.1迁移说明并入导语，附录共18节；短篇阅读说明和分类概览不机械细分。其余四卷附录仍为待写骨架，节与小节的成熟程度不由数量代表。
