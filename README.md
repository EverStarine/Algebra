...
当前为**可编译的项目骨架**：已建立编、章、节与附录，保留标题、选读标记及写作任务注释；正文、证明、习题与文献尚待编写。根目录 PDF 是目录与版式预览，不是完成稿。

## 五卷结构

| 卷 | 书名与源码入口 | 编 | 章 | 正文节 | 附录 | 已明确的附录节 | PDF 预览 |
|---|---|---:|---:|---:|---:|---:|---|
| 一 | [群、环、域与 Galois 理论](Book1/Book1.tex) | 3 | 22 | 89 | 5 | 3 | [Book1.pdf](Book1.pdf) |
| 二 | [模、多线性代数与非交换环](Book2/Book2.tex) | 4 | 20 | 84 | 4 | 5 | [Book2.pdf](Book2.pdf) |
| 三 | [交换代数与代数几何方法](Book3/Book3.tex) | 4 | 24 | 106 | 7 | 21 | [Book3.pdf](Book3.pdf) |
| 四 | [范畴与同调代数](Book4/Book4.tex) | 4 | 20 | 84 | 3 | 0 | [Book4.pdf](Book4.pdf) |
| 五 | [表示论：有限群、箭图与李代数](Book5/Book5.tex) | 4 | 22 | 95 | 5 | 6 | [Book5.pdf](Book5.pdf) |
| 合计 | | 19 | 108 | 458 | 24 | 35 | |

每卷独立编号。12 个选读章、8 个选读节沿用纲要的星号；附录显示为 A、B、C……，不加卷号或选读星号。没有明确分节的附录仅建立附录入口，不另造节名。五卷的学习次序与先修分流见纲要，不将出版顺序当作单一先修链。
...
BookN/
  ...
  PartXX/
    ...
    ChapterCC/
      ChapterCC.tex             章入口
      SectionCCSS.tex           第 CC 章第 SS 节
  Appendices/
    Appendices.tex              附录总入口
    AppendixA/
      AppendixA.tex             附录 A 入口
      SectionA01.tex            纲要明确列出的附录 A.1（若有）
...
TeX 文件采用 UTF-8。纲要节下的要点保存在相应源文件的注释中，作为待写清单；只有明确的节标题建立节文件。以后修改纲要或目录时同步修改入口、标题和标签。不要用初始化生成器覆盖已经写好的正文。
