...
设 \(\mathcal A,\mathcal B,\mathcal C\) 为交换范畴，\(\mathcal A,\mathcal B\) 有足够内射对象。设加性函子 \(F:\mathcal A\to\mathcal B\) 正合，\(G:\mathcal B\to\mathcal C\) 左正合，且每个内射 \(I\in\mathcal A\) 的像 \(F(I)\) 都对 \(G\) 无上同调。则对每个 \(M\in\mathcal A\) 及 \(n\ge0\)，有自然同构
\[
...
设 \(\mathcal A,\mathcal B,\mathcal C\) 为交换范畴，\(\mathcal A\) 有足够内射对象，\(F:\mathcal A\to\mathcal B\) 为左正合加性函子，\(G:\mathcal B\to\mathcal C\) 为正合加性函子。则
\[
