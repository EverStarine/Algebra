...
设 \(k\) 为域，\(R=k[\varepsilon]/(\varepsilon^2)\)，\(C=(R\xrightarrow{\varepsilon}R)\) 位于 \(-1,0\) 次。证明 \(H^{-1}C=H^0C=k\)，但 \(C\) 在左 \(R\)-模导出范畴 \(D(R)\) 中不同构于 \(k[1]\oplus k\)，其中 \(k=R/(\varepsilon)\)。
\end{exercise}
\begin{solution}
