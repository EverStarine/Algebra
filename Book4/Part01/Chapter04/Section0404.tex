...
在交换范畴中，设两张满足\cref{b4:thm:snake-lemma}条件的图之间给定交换图的态射。其诱导的 \(s:\ker\gamma\to\ker\widetilde\gamma\) 与 \(t:\operatorname{coker}\alpha\to\operatorname{coker}\widetilde\alpha\) 满足
\[
